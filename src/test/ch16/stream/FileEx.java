...
public class FileEx {
	...
	public static void main(String[] args) throws IOException {
		...
		//디렉토리나 파일이 없으면 생성
		if(dir.exists() == false) { dir.mkdir(); } //file 존재 여부. 있으면 true, 없으면 false
		if(dir.exists() == false) { file1.createNewFile(); } //file 존재 여부. 있으면 true, 없으면 false
		if(dir.exists() == false) { file2.createNewFile(); } //file 존재 여부. 있으면 true, 없으면 false
		if(dir.exists() == false) { file3.createNewFile(); } //file 존재 여부. 있으면 true, 없으면 false
